    ...
    if request.POST:
        ...
        if user is not None:
            if user.is_active:
                ...
                resp['msg'] = "Password o usuario incorrecto"
        else:
            resp['msg'] = "Password o usuario incorrecto"
...
def save_product(request):
    ...
    if len(check) > 0 :
        resp['msg'] = "El codigo de producto ya existe."
    else:
        ...
        try:
            if (data['id']).isnumeric() and int(data['id']) > 0 :
                ...
                save_product.save()
            resp['status'] = 'success'
            messages.success(request, 'Product guardado correctamente.')
        except:
            resp['status'] = 'failed'
    return HttpResponse(json.dumps(resp), content_type="application/json")
...
def delete_product(request):
    ...
    try:
        ...
        resp['status'] = 'success'
        messages.success(request, 'Producto borrado correctamente.')
    except:
        resp['status'] = 'failed'
    return HttpResponse(json.dumps(resp), content_type="application/json")
@login_required
...
def save_pos(request):
    ...
    try:
        ...
        messages.success(request, "La venta ha sido guardada con exito")
    except:
...
def salesList(request):
    ...
    # print(sale_data)
    context = {
        'page_title':'Transacciones de venta',
        'sale_data':sale_data,
    }
    # return HttpResponse('')
...
def delete_sale(request):
    ...
    try:
        ...
        resp['status'] = 'success'
        messages.success(request, 'El registro de venta ha sido borrado.')
    except:
        resp['msg'] = "Ocurrio un error"
        print("Error inesperado:", sys.exc_info()[0])
    return HttpResponse(json.dumps(resp), content_type='application/json')